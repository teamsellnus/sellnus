...
?>
	<style>
		.itemform ul { list-style:none; margin:0; padding:15px; }
		.itemform ul li { line-height:28px; }
	</style>
	...
	<div class="btn_fixed_top">
		...
		<a href="./itemlist.php?<?php echo $qstr;?>" class="btn btn_02">상품목록</a>
		<?php if($it_id) { ?>
			<a href="<?php echo G5_SHOP_URL;?>/item.php?it_id=<?php echo $it_id;?>" target="blank" class="btn btn_02">보기</a>
			<a href="./itemform.php" class="btn btn_03">신규</a>
		<?php } ?>
	</div>
