...
sql_query(" ALTER TABLE `{$g5['apms_xp']}` ADD `youtube_key` varchar(255) NOT NULL DEFAULT '' AFTER `google_map_key` ", false);
sql_query(" ALTER TABLE `{$g5['apms_xp']}` ADD `seo_img` varchar(255) NOT NULL DEFAULT '' AFTER `youtube_key` ", false);
