...
.tbl_head01 tbody tr:nth-child(2n) { background: #fff; }
.grade-txt span { display:inline-block; width:250px; margin:3px 0px;}
</style>
<div class="local_ov01 local_ov">
	<a href="http://amina.co.kr/bbs/board.php?bo_table=apms" target="_blank" class="ov_listall">업데이트 확인</a>
	<span class="btn_ov01"><span class="ov_txt">버전 </span><span class="ov_num"> <?php echo APMS_VERSION;?></span></span>
</div>
...
<div class="tbl_head01 tbl_wrap">
	...
	<td align="center"><?php echo apms_thema_skin($thema_list, 'as_thema', $config['as_thema'], 'basic_thema', 'as_color', '테마 선택', '100%');?></td>
	<td align="center">
		<div id="basic_thema">
			<?php echo apms_colorset_skin($config['as_thema'], 'as_color', $config['as_color'], '', '100%');?>
		</div>	
	</td>
	<td align="center"><?php echo apms_thema_skin($thema_list, 'as_mobile_thema', $config['as_mobile_thema'], 'basic_mobile_thema', 'as_mobile_color', '테마 선택', '100%');?></td>
	<td align="center">
		<div id="basic_mobile_thema">
			<?php echo apms_colorset_skin($config['as_mobile_thema'], 'as_mobile_color', $config['as_mobile_color'], '', '100%');?>
		</div>	
	</td>
	<?php 
	...
	<?php if(IS_YC) { ?>
		...
		<td align="center"><?php echo apms_thema_skin($thema_list, 'as_shop_thema', $default['as_thema'], 'basic_shop_thema', 'as_shop_color', '테마 선택', '100%');?></td>
		<td align="center">
			<div id="basic_shop_thema">
				<?php echo apms_colorset_skin($default['as_thema'], 'as_shop_color', $default['as_color'], '', '100%');?>
			</div>	
		</td>
		<td align="center"><?php echo apms_thema_skin($thema_list, 'as_shop_mobile_thema', $default['as_mobile_thema'], 'basic_shop_mobile_thema', 'as_shop_mobile_color', '테마 선택', '100%');?></td>
		<td align="center">
			<div id="basic_shop_mobile_thema">
				<?php echo apms_colorset_skin($default['as_mobile_thema'], 'as_shop_mobile_color', $default['as_mobile_color'], '', '100%');?>
			</div>	
		</td>
...
<style>
.data-management .btn { display:block !important; text-align:center; }
</style>

<div class="local_desc01 local_desc">
	<b>● 자료관리</b> 
</div>
<div class="tbl_head01 tbl_inline tbl_wrap data-management">
	<table>
    <thead>
    <tr>
		<th width="160" scope="col">구분</th>
        <th scope="col">설명</th>
	</tr>
	</thead>
    <tbody>
		<tr>
		<td>
			<a href="./apms.admin.php?ap=update" class="btn btn_01">DB 업데이트</a>
		</td>
		<td>
			아미나빌더에서 사용하는 DB 테이블 및 필드를 업데이트합니다.
		</td>
		</tr>
		<tr>
		<td>
			<a href="<?php echo G5_ADMIN_URL;?>/apms_admin/apms.exp.update.php" class="btn btn_02 win_memo">회원레벨 업데이트</a>
		</td>
		<td>
			경험치룰 변경 등에 따라 전체회원의 레벨을 재산정할 때 적용합니다.		
		</td>
		</tr>
		<tr>
		<td>
			<a href="<?php echo G5_ADMIN_URL;?>/apms_admin/apms.new.update.php" class="btn btn_02 win_memo">게시물 업데이트</a>
		</td>
		<td>
			게시물의 대표이미지, 글타입 등 추가적인 정보를 업데이트합니다.
		</td>
		</tr>
		<?php if (defined('G5_USE_SHOP') && G5_USE_SHOP) { ?>
			<tr>
			<td>
				<a href="<?php echo G5_ADMIN_URL;?>/apms_admin/apms.it.update.php" class="btn btn_02 win_memo">상품정보 업데이트</a>
			</td>
			<td>
				상품의 대표이미지 등 추가적인 정보를 업데이트합니다.
			</td>
			</tr>
		<?php } ?>
		<tr>
		<td>
			<a href="<?php echo G5_ADMIN_URL;?>/apms_admin/apms.new.recover.php" class="btn btn_02 win_memo">새글DB 복구</a>
		</td>
		<td>
			기본환경설정의 최근글 삭제일 변경 등에 따른 새글DB 재생성 실행합니다.
		</td>
		</tr>
		<tr>
		<td>
			<a href="<?php echo G5_ADMIN_URL;?>/apms_admin/apms.exp.default.php" class="btn btn_02 win_memo">포인트 정리</a>
		</td>
		<td>
			회원 포인트 및 경험치별 포인트 내역 통합하거나 초기화시 실행합니다. 
		</td>
		</tr>
		<tr>
		<td>
			<a href="<?php echo G5_ADMIN_URL;?>/apms_admin/apms.img.delete.php" class="btn btn_02 win_memo">이미지 정리</a>
		</td>
		<td>
			/data/apms/video 폴더 내의 동영상 이미지를 정리합니다.
		</td>
		</tr>
		<tr>
		<td>
			<a href="<?php echo G5_ADMIN_URL;?>/apms_admin/apms.photo.delete.php" class="btn btn_02 win_memo">회원사진 정리</a>
		</td>
		<td>
			기존 아미나빌더 회원사진을 그누 5.3 이상버전의 회원사진으로 전환합니다.
		</td>
		</tr>
		<tr>
		...
		<td>
			<?php echo help("스팸글 필터링 단어를 콤마(,)로 구분해서 등록해 주세요."); ?>
			<textarea name="spam_msg" rows="10" id="spam_msg"><?php echo $xp['spam_msg'];?></textarea>
		</td>
		</tr>
	</tbody>
	</table>
...
?>
	<div class="local_desc01 local_desc">
		<b>● 쇼핑몰 기본 설정</b> - 쇼핑몰 관련 추가설정입니다.
	</div>

	<div class="tbl_head01 tbl_inline tbl_wrap">
		<table>
	    <thead>
		<tr>
		<th width=80>구분</th>
	...
	<div class="local_desc01 local_desc">
		<b>● 쇼핑몰 페이지 설정</b> - 페이지별 기본 출력 목록수, 페이지 스킨 등
	</div>
	...
	<div class="tbl_head01 tbl_wrap">
		...
		<td class="td_left">장바구니, 주문서, 주문내역, 개인결제 등</td>
		</tr>
		<tr>
		...
		<td class="td_left">인기,추천,할인 등 상품유형별 페이지</td>
		</tr>	
		<tr>
		...
		<td class="td_left">파트너 개별 샵 페이지</td>
		</tr>	
		<tr>
		...
		<td class="td_left">이벤트 배너 페이지</td>
		</tr>	
		<tr>
...
<div class="local_desc01 local_desc">
	<b>● 회원 설정</b> - XP는 처음 설정 저장 후 또는 설정 변경시 <b>'업데이트'</b>를 실행해야 모든 회원에게 일괄적용됩니다.
</div>
...
<div class="local_desc01 local_desc">
	<b>● 기능 설정</b> - SEO, 럭키포인트, API Key 등 설정
</div>
...
<div class="tbl_head01 tbl_inline tbl_wrap">
	...
	<td>
		<label>
			<input type="checkbox" name="video_img" value="1"<?php if($xp['video_img']) echo ' checked';?>>
			동영상 썸네일용 대표이미지를 서버에 저장합니다.
		</label>
	</td>
	</tr>
	<tr>
	...
	<td>
		...
		<input type="text" id="youtube_key" name="youtube_key" size="100" value="<?php echo $xp['youtube_key'];?>" class="frm_input">	
		<a class="btn_frmline" href="https://developers.google.com/youtube/v3/getting-started?hl=ko" target="_blank">발급받기</a>
	</td>
	</tr>
	</tbody>
	</table>
