...
<form id="widgetForm" name="widgetForm" method="post" enctype="multipart/form-data" action="<?php echo $action_url;?>">
	...
	<div class="uploader btn_confirm01 btn_confirm" style="margin:0px">
		<input type="file" name="upload_file" value="">
		<input type="submit" value="등록하기" class="btn_submit" accesskey="s">
	</div>
</form>
...
<ul class="widget-wrap">
	...
	<?php
		...
		$srow_cnt = (is_array($srow)) ? count($srow) : 0;
