...
>>>>>>> feature/header
	...
	* {
	...
	section .content-box .login-form-box .form-header .form-logo-wrap {
		display: block;
		padding: 0;
		margin-bottom: 50px;
	}

	section .content-box .login-form-box .form-header .form-logo {
		font-size: 30px;
		line-height: 30px;
...
<section>
	<div class="img-box">
		<img src="<?php echo G5_URL ?>/img/login-bg.jpg" alt="">
	</div>
	<div class="content-box">
		<div class="login-form-box">
			<div class="form-header">
				<div class="form-logo-wrap">
					<a class="form-logo" href="#!">Sell&Us</a>
				</div>
				<h2>Hello, Welcome Back!</h2>
			</div>
			<form class="form input-box" role="form" name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
				<input type="hidden" name="url" value='<?php echo $login_url ?>'>
				<div class="form-group has-feedback">
					<label for="login_id"><b>아이디</b><strong class="sound_only"> 필수</strong></label>
					<input type="text" name="mb_id" id="login_id" required class=" input-sm" size="20" maxLength="20">
					<span class="fa fa-user form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback">
					<label for="login_pw"><b>비밀번호</b><strong class="sound_only"> 필수</strong></label>
					<input type="password" name="mb_password" id="login_pw" required class=" input-sm" size="20" maxLength="20">
