	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row"><label for="it_name">Product name</label></th>
				...
				<tr>
					<th scope="row"><label for="it_price">Price</label></th>
					<td class="justi-center">
						<input type="number" name="it_price" placeholder="숫자만 입력해주세요," value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input" size="8"> 원
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="ca_id">Category</label></th>
					<td class="justi-center">
				...
				?>
				<tr>
					<th scope="row"><label for="it_use">Available for sale</label></th>
					<td class="justi-center-column">
						<?php echo help("If you stop selling for a while or if you don't have stock, it won't be printed out and you don't accept orders."); ?>
						<label><input type="checkbox" name="it_use" value="1" id="it_use" <?php echo ($it['it_use']); ?> checked>&nbsp;Yes</label>
					</td>
				</tr>
				<!-- <tr>
				...
				<tr>
					...
					<td class="justi-center">
						<input type="radio" name="it_1" value="Used" <?php echo $it['it_1']; ?> checked>Used&nbsp;
						<input type="radio" name="it_1" value="Brand New" <?php echo $it['it_1']; ?>>Brand New
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="pt_tag">Tags</label></th>
					<td>
						<?php echo help("Enter the product tags to be registered by dividing them into commas (,)."); ?>
						<input type="text" name="pt_tag" value="<?php echo get_text($it['pt_tag']); ?>" id="pt_tag" class="frm_input sl">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="it_stock_qty">Quantity</label></th>
					<td>
						<?php echo help("If you set the inventory to 0, it will be marked as out of stock."); ?>
						<input type="text" name="it_stock_qty" value="<?php echo $it['it_stock_qty']; ?>" id="it_stock_qty" class="frm_input" size="8"> 개
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="it_sc_type">Shipping</label></th>
					<td>
						<?php echo help("Please select the shipping type."); ?>
						...
						<tr>
							...
							<td>
								...
								<?php } else { ?>
									...
									<script>
										$(function() {
											$("#pt_reserve_date").datepicker({
												changeMonth: true,
												changeYear: true,
												dateFormat: "yy-mm-dd",
												showButtonPanel: true,
												yearRange: "c-0:c+99",
												maxDate: "<?php echo $default['pt_reserve_end'] ?>"
											});
										});
									</script>
									&nbsp;
