...
<style>
	<?php if ($is_dhtml_editor) { ?>#wr_content {
		border: 0;
		display: none;
	}

	<?php } ?>.write-wrap label {
		margin-top: 0px;
	}
...
<div class="write_main_wrap">
	...
	<div id="bo_w" class="write-wrap<?php echo (G5_IS_MOBILE) ? ' font-14' : ''; ?> at-container">
		...
		<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" role="form" class="form-horizontal">
			...
			<div class="form-group write_title_wrap">
				<p class="col-sm-2 control-label write_title" for="wr_subject">Title<strong class="sound_only">필수</strong></p>
			</div>
			<div class="col-sm-12 write_title_inputBx">
				<div class="input-group">
					<input placeholder="Type here..." type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control input-sm" size="50" maxlength="255">
			...
			?>
				<!-- <div class="form-group write_tagsBx">
				<p class="col-sm-2 control-label write_tags_title" for="as_tag">Tags</p>
				<div class="col-sm-12">
		...
		<div class="form-group" style="margin-bottom:0;">
			...
			<div class="write-btn pull-center">
				<button type="submit" id="btn_submit" accesskey="s" class="btn write_submit_btn btn-sm"><b>submit</b></button>
				<a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn btn-black btn-sm" role="button">cancle</a>
			</div>
